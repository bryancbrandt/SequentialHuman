...
from state_digraph import StateDiGraph
...
class ExpertAnchorBaseline(FullAnchoringBaseline):
    ...
    def __init__(self, map_name: str, expert_data: dict, max_episode_length: int = 260,
                 max_episode_threshold: int = 187, gamma: float = .99, rho: float = .5):
        """

        :param map_name:
        :param expert_data:
        :param max_episode_length:
        :param max_episode_threshold:
        :param gamma:
        :param rho:
        """
