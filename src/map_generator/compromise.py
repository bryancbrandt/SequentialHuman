...
map_name = "../csv_maps/compromise_training_" + str(MAP_NUMBER) + ".csv"
            ...
            if not data[row_col[0]][row_col[1]] == START:
                if not data[row_col[0]][row_col[1]] == EXIT_A:
                    if not data[row_col[0]][row_col[1]] == EXIT_B:
                        if not data[row_col[0]][row_col[1]] == EXIT_C:
...
def main():
    ...
    for i in range(20):
        for j in range(20):
            ...
            elif value == EXIT_A or value == EXIT_B or value == EXIT_C:
                road_rect.top = top
                road_rect.left = left
                screen.blit(road, road_rect)
                exit_rect.top = top
    ...
    NAME = "compromise_training_" + str(MAP_NUMBER)
